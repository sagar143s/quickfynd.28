...
const COMPANY_NAME = process.env.NEXT_PUBLIC_INVOICE_COMPANY_NAME || "QuickFynd";
...
const COMPANY_CONTACT = process.env.NEXT_PUBLIC_INVOICE_CONTACT || "Email: support@QuickFynd.com";
